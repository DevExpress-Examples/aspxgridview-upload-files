...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" OnCustomErrorText="ASPxGridView1_CustomErrorText" OnRowUpdating="ASPxGridView1_RowUpdating" DataSourceID="SqlDataSource1" KeyFieldName="ProductID" OnCustomUnboundColumnData="ASPxGridView1_CustomUnboundColumnData">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="Url" UnboundType="Object" VisibleIndex="6">
                        ...
                        <EditItemTemplate>
                            <dx:ASPxUploadControl ID="ASPxUploadControl1" ShowProgressPanel="true" UploadMode="Auto" FileUploadMode="OnPageLoad" OnFileUploadComplete="ASPxUploadControl1_FileUploadComplete" runat="server" Width="280px" AddUploadButtonsHorizontalPosition="Center" ShowUploadButton="True">
